...
import { GeminiImageService, type GeneratedImage, type ReferenceImage } from "@/services/gemini";
...
export function ImageGenerator({ apiKey }: ImageGeneratorProps) {
  ...
  const handleGenerate = async () => {
    ...
    try {
      const images = await geminiService.generateImages(prompt, referenceImages.length > 0 ? referenceImages : undefined);
